...
- **Frontend-Live:** [https://food-ordering-gray-six.vercel.app](https://food-ordering-gray-six.vercel.app)
- **Backend-Live:** [https://food-ordering-zlal.onrender.com](https://food-ordering-zlal.onrender.com)
...
- **User Authentication**: Custom JWT authentication with Google OAuth integration
...
# Stripe Configuration
VITE_STRIPE_PUB_KEY="pk_test_your-stripe-public-key"
```
...
2. **Deploy to Render**
   ...
   - Set environment variables (Make sure to set `NODE_ENV=production`)
...
```env
# Production URLs
FRONTEND_URL="https://food-ordering-gray-six.vercel.app"
VITE_API_BASE_URL="https://food-ordering-zlal.onrender.com"
